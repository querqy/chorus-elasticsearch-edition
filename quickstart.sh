...
# curl -X POST "localhost:9200/_security/user/chorus_admin?pretty" -H 'Content-Type: application/json' -d'
# {
#   "password" : "password",
#   "roles" : ["superuser"]
# }
...
# curl -X POST "localhost:9200/_security/role/anonymous_user" -H 'Content-Type: application/json' -d'
# {
#   "run_as": [ ],
#   "cluster": [ ],
#   "indices": [
...
curl -s -X PUT "http://localhost:9200/ecommerce/_settings"  -H 'Content-Type: application/json' -d '{"index.mapping.total_fields.limit": 10000}'
